  ...
  return (
    <Box mb="16px">
      <Flex alignItems="center" mb="8px">
        <Text className="sharp-bold" bold>{translateString(90, 'Transaction deadline')}</Text>
        <QuestionHelper
          text={translateString(188, 'Your transaction will revert if it is pending for more than this long.')}
        />
      </Flex>
      <Field>
        <Input className="panel-styling sharp-semibold" type="number" step="1" min="1" value={value} onChange={handleChange} />
